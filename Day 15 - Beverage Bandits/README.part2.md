...
You need to make sure the Elves not only **win**, but also suffer
**no losses**: even the death of a single Elf is unacceptable.
...
**lowest integer attack power** (at least `4`) that allows them to **win
